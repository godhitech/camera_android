        ...
        new CameraDevice.StateCallback() {
          ...
          public void onClosed(@NonNull CameraDevice camera) {
            try{
              ...
              Log.e(TAG, "open | onClosed error: " + e.getMessage());
              dartMessenger.sendCameraErrorEvent(e.getMessage());
            }
          }
...
//    }
  ...
  public void setFocusPoint(@NonNull final Result result, @Nullable Point point) {
    try{
      ...
      Log.e(TAG, "setFocusPoint | error: " + e.getMessage());
      result.error("setFocusPointFailed", e.getMessage(), null);
    }
  }
  ...
  void closeCaptureSession() {
    try{
      ...
      Log.e(TAG, "closeCaptureSession: " + e.getMessage());
    }
  }
  ...
  private void stopAndReleaseCamera() {
    try{
      ...
      Log.e(TAG, "stopAndReleaseCamera: " + e.getMessage());
    }
  }
